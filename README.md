...
고객 화면과 내부 견적 화면은 같은 Next.js 프로젝트에 있으며, 내부 API는 별도 백엔드 팀의 서비스가 아니라 이 저장소의 Route Handler로 구현했습니다. 따라서 이 프로젝트는 프론트엔드와 API 연결 경험을 보여주지만, 백엔드 개발자와 협업한 운영 경험을 뜻하지는 않습니다.
